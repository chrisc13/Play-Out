...
class ViewProfileController: UIViewController, UICollectionViewDelegateFlowLayout, UICollectionViewDelegate, UICollectionViewDataSource{
    ...
    func setupStack(){
        ...
        //editBttn.setTitle("Edit", for: .normal)
      /*let sH = NSLayoutConstraint.constraints(withVisualFormat: "H:|-0-[userImageView]-0-|", options: NSLayoutConstraint.FormatOptions(rawValue: 0), metrics: nil, views: ["userImageView":userImageView])
        let sV = NSLayoutConstraint.constraints(withVisualFormat: "V:|-0-[stackView]-0-|", options: NSLayoutConstraint.FormatOptions(rawValue:0), metrics: nil, views: ["userImageView":userImageView])
        */
